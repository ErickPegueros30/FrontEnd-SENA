...
const acreditaciones: Document[] = [ // Alcance
  {
    ...
    fileUrl: '/pdf/Acreditamientos/ACREDITAMIENTO PEA-ENS-05.pdf',
    size: null,
    paginas: 4,
    fecha: '21/01/2025',
...
const dictamenes: Document[] = [
  {
    ...
    fileUrl: '/pdf/Dictamen/DICTAMEN EMA PEA-ENS-05.pdf',
    size: '3.2 MB',
    paginas: 1,
    fecha: '21/01/2025',
    emisor: 'Entidad Mexicana de Acreditación (EMA)',
  ...
  },
  {
    ...
    fileUrl: '/pdf/Dictamen/DICTAMEN EMA PEA-CAL-01.pdf',
    size: '2.1 MB',
    paginas: 1,
    fecha: '21/01/2025',
    emisor: 'Entidad Mexicana de Acreditación (EMA)',
